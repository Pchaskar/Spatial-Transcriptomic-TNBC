...
tiff("./images/Figure3_part1.tiff", width = 4, height = 3.5, 
...
tiff("./images/Figure3_part2.tiff", width = 8, height = 10, 
     units = 'in', res = 600, compression =  "lzw+p")
draw(Heatmap(deg_vsd_matrix_scaled,
                                              show_row_names = FALSE, show_row_dend = FALSE, 
                                              cluster_rows = hr,
                                              cluster_columns = hc,
                                              heatmap_legend_param = list(title = "scale", 
                                                                          color_bar = "continuous"),
                                              col=mycols, column_names_gp = gpar(fontsize = 10), row_title="genes",
...
#Plot heatmap as grob
tiff("./images/Figure3_part3.tiff", width = 8, height = 10, 
     units = 'in', res = 600, compression =  "lzw+p")
draw(Heatmap(heat,
                                               #name = "x",
                                               show_row_dend = FALSE,
                                               width = unit(10, "cm"), height = unit(22, "cm"),
                                               show_row_names = TRUE,
